...
const sendCommand = {
  ...
  execute: async (ctx) => {
    ...
    await ctx.reply(
      "Пожалуйста, введите сообщение для рассылки. Вы можете использовать HTML-теги для форматирования, а также отправлять фото с подписью. Для отмены введите /cancel.",
      Markup.forceReply()
    );
  },
